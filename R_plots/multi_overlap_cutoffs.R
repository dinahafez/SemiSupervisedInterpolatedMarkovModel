...
setwd("/Users/Dina/Duke/Uwe_Lab/Drosophila/Research/results_idr_0.2/Initialization_Stark_RedFly_uniqGenes/ClustersDHS/MC_2order/Overlap/5_mer")
allAUC=NULL;
sum = 0;
total=0;
for(i in 11:39)
...
for(i in 11:39)
{
  ...
  file3 = paste(i,"_pos_14_single_ubiquitous_single_Classifier.ROC", sep="")
...
#########PLOT
pdf("/Users/Dina/Duke/Uwe_Lab/Drosophila/Research/Graphs/overlap_cutoffs.pdf")
