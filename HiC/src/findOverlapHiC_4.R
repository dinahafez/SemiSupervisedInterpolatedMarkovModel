...
permute = args[1];
enhancers_bed <- file.path("/data/ohler/Dina/Drosophila/Research/results_idr_0.2/AssignDHSToRandomGene/", "partnerTogene_intersect_DHS_uniq.bed")
file1 = paste ("DHStoRandomeGene", permute, sep="_");
#file2 = paste(file1, ".bed_intersect_sexton_partnerTogene.bed.filtered.uniq.bed", sep="")
file2 = "stage1_14_stage2_10_intersect_partnerToGene_uniq.bed";
...
file5 = "stage1_14_stage2_10_overlaps_HiC_genes.bed";
...
file3 = "stage1_14_stage2_10_overlaps_HiC.bed";
